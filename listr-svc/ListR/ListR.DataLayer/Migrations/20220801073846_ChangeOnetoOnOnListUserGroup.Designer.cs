...
namespace ListR.DataLayer.Migrations
{
    ...
    [Migration("20220801073846_ChangeOnetoOnOnListUserGroup")]
    partial class ChangeOnetoOnOnListUserGroup
    {
            ...
            modelBuilder.Entity("ListR.DataLayer.EntityModels.Lists.ShopList", b =>
                {
                    b.HasOne("ListR.DataLayer.EntityModels.Users.UserGroup", null)
                        .WithOne("List")
                        .HasForeignKey("ListR.DataLayer.EntityModels.Lists.ShopList", "UserGroupId")
